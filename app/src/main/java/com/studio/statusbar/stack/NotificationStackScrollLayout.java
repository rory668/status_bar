...
import com.studio.statusbar.ExpandHelper;
import com.studio.statusbar.animation.Interpolators;
import com.studio.statusbar.R;
import com.studio.statusbar.SwipeHelper;
import com.studio.statusbar.notification.ActivatableNotificationView;
import com.studio.statusbar.DismissView;
import com.studio.statusbar.panel.EmptyShadeView;
import com.studio.statusbar.notification.ExpandableNotificationRow;
import com.studio.statusbar.ExpandableView;
import com.studio.statusbar.notification.NotificationGuts;
import com.studio.statusbar.notification.NotificationSettingsIconRow;
import com.studio.statusbar.notification.NotificationSettingsIconRow.SettingsIconRowListener;
import com.studio.statusbar.stack.StackScrollerDecorView;
import com.studio.statusbar.panel.StatusBarState;
import com.studio.statusbar.notification.FakeShadowView;
import com.studio.statusbar.notification.NotificationUtils;
import com.studio.statusbar.notification.NotificationGroupManager;
import com.studio.statusbar.panel.PhoneStatusBar;
import com.studio.statusbar.ScrimController;
import com.studio.statusbar.policy.ScrollAdapter;
...
public class NotificationStackScrollLayout extends ViewGroup
    ...
    private void requestAnimationOnViewResize(ExpandableNotificationRow row) {
        if (mAnimationsEnabled && (mIsExpanded || row != null)) {
    ...
    public boolean updateSwipeProgress(View animView, boolean dismissable, float swipeProgress) {
        if (!mIsExpanded && canChildBeDismissed(animView)) {
        }
        ...
        for (int childIdx = 0; childIdx < count; childIdx++) {
            ...
            if (touchY >= top && touchY <= bottom && touchX >= left && touchX <= right) {
                if (slidingChild instanceof ExpandableNotificationRow) {
                    ...
                    if (!mIsExpanded && row.isPinned()
                            && mGroupManager.getGroupSummary() != row) {
                        continue;
                    }

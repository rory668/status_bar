...
import com.studio.statusbar.ExpandableNotificationRow;
import com.studio.statusbar.notification.NotificationUtils;
import com.studio.statusbar.phone.NotificationPanelView;
...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    private void initDimens() {
        ...
        mCollapsedBottompadding = getResources().getDimensionPixelSize(
                R.dimen.notification_content_margin_bottom);
    }
    ...
    public void updateGroupOverflow() {
        ...
        if (childCount > maxAllowedVisibleChildren) {
            mOverflowNumber = bindOverflowNumber(
